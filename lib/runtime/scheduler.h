 ...
 */
#define LPTSI 10000  /* low priority time slice interval 100us */  // ~10k fibers/thread
#define NPTSI 15000  /* norm priority time slice interval 150us */ // ~6k fibers/thread
#define HPTSI 25000 /* high priority time slice interval 250us */ // ~4k fibers/thread
