...
# g++ main.cpp -DSHARP_PROF_ lib/runtime_old/*.cpp lib/Modules/*/*.cpp lib/runtime_old/*/*.cpp lib/util/*.cpp lib/util/zip/*.cpp lib/util/fmt/src/*.cc lib/util/jit/asmjit/src/asmjit/x86/*.cpp lib/util/jit/asmjit/src/asmjit/base/*.cpp -o bin/tanto -std=c++11 -pthread -lm -lrt -lstdc++ -O3 -ldl
